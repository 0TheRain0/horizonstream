...
1. Open the [extension instructions](chrome-extension/README.md), select its toolbar icon to open the side panel, then select **Open PS Remote Play sign-in** and complete Sony's normal sign-in in Chrome.
