...
4. In Horizon Stream, choose **Scan sign-in QR code** and look at the QR code through the headset. Horizon Stream completes the Account-ID lookup on the Quest. Other compatible clients can use the copied redirect URL instead.
