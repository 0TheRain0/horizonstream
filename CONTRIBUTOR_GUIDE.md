...
This file is a quick orientation for new contributors working on `Horizon Stream`.

## What This Repository Is

`Horizon Stream` is a cross-platform PlayStation Remote Play client. The codebase is split into:
