...
1. In the [Horizon Stream PSN Account ID extension](chrome-extension/README.md), select **Open PS Remote Play sign-in** and complete Sony's normal sign-in in Chrome.
