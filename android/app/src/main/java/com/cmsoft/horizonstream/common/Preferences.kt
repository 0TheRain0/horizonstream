...
import com.cmsoft.horizonstream.lib.Codec
import com.cmsoft.horizonstream.lib.ConnectVideoProfile
import com.cmsoft.horizonstream.lib.VideoFPSPreset
import com.cmsoft.horizonstream.lib.VideoResolutionPreset
...
class Preferences(context: Context)
{
	...
	enum class Codec(val value: String, @StringRes val title: Int, val codec: com.cmsoft.horizonstream.lib.Codec)
	{
		CODEC_H264("h264", R.string.preferences_codec_title_h264, com.cmsoft.horizonstream.lib.Codec.CODEC_H264),
		CODEC_H265("h265", R.string.preferences_codec_title_h265, com.cmsoft.horizonstream.lib.Codec.CODEC_H265)
	}
